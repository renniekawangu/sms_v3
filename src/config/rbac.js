...
export const ROUTE_ACCESS = {
  ...
  '/attendance': [ROLES.TEACHER, ROLES.HEAD_TEACHER, ROLES.ADMIN, ROLES.STUDENT],
  '/subjects': [ROLES.TEACHER, ROLES.HEAD_TEACHER, ROLES.ADMIN, ROLES.STUDENT],
  '/subjects/:id': [ROLES.TEACHER, ROLES.HEAD_TEACHER, ROLES.ADMIN, ROLES.STUDENT],
  '/timetable': [ROLES.TEACHER, ROLES.HEAD_TEACHER, ROLES.ADMIN, ROLES.STUDENT],
  '/exams': [ROLES.TEACHER, ROLES.HEAD_TEACHER, ROLES.ADMIN, ROLES.STUDENT],
  '/results': [ROLES.TEACHER, ROLES.HEAD_TEACHER, ROLES.ADMIN, ROLES.STUDENT],
  ...
  '/report-cards': [ROLES.HEAD_TEACHER, ROLES.ADMIN, ROLES.TEACHER],
