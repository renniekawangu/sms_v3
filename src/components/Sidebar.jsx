...
const allMenuItems = {
  ...
  subjects: { label: 'Subjects', icon: BookOpen, path: '/subjects', roles: [ROLES.ADMIN, ROLES.TEACHER, ROLES.HEAD_TEACHER, ROLES.STUDENT] },
  ...
  results: { label: 'Results', icon: Award, path: '/results', roles: [ROLES.ADMIN, ROLES.TEACHER, ROLES.HEAD_TEACHER, ROLES.STUDENT] },
  reportCards: { label: 'Report Cards', icon: Bookmark, path: '/report-cards', roles: [ROLES.ADMIN, ROLES.TEACHER, ROLES.HEAD_TEACHER] },
  resultsApproval: { label: 'Results Approval', icon: CheckCircle, path: '/results-approve', roles: [ROLES.ADMIN, ROLES.HEAD_TEACHER] },
  attendance: { label: 'Attendance', icon: CheckCircle, path: '/attendance', roles: [ROLES.ADMIN, ROLES.TEACHER, ROLES.HEAD_TEACHER, ROLES.STUDENT] },
  ...
  studentAccount: { label: 'My Account', icon: DollarSign, path: '/student-account', roles: [ROLES.STUDENT] },
  issues: { label: 'Issues', icon: AlertCircle, path: '/issues', roles: [ROLES.ADMIN] },
